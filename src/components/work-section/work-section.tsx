...
const tabs: Tab[] = [
  {
    ...
    image: "/images/projects/parx.jpg",
  },
  {
    id: "web-dev",
    ...
    image: "/images/projects/thumbnail-web-design.webp",
  },
  {
    id: "logo-design",
    title: "Logo Design",
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="relative w-full aspect-video md:aspect-[16/10]">
              ...
              {/* Coming Soon Overlay */}
              {/* {activeTabData.isComingSoon && (
                <div className="absolute inset-0 bg-background/60 backdrop-blur-sm z-10 flex items-center justify-center">
                  <div className="px-4 py-2 border-2 border-primary/50 bg-background/80 rounded-lg shadow-xl flex items-center gap-3">
                    <span className="relative flex h-3 w-3">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-pink-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-3 w-3 bg-pink-500"></span>
                    </span>
                    <h3 className="text-[10px] md:text-xs font-bold tracking-tight text-foreground capitalize">
                      Coming Soon
                    </h3>
                  </div>
                </div>
