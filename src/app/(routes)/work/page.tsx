...
export default function WorkPage() {
  ...
  useEffect(() => {
    // Simulate data loading to display skeletons
  ...
  return (
    <Container>
      <div className="flex flex-col w-full min-h-screen">
        {/* Banner Section */}
        <section className="flex flex-col-reverse lg:flex-row w-full items-stretch border-b border-border">
                        ...
                        >
                          ...
                          <div className="lg:w-1/4 p-4 md:p-8 flex flex-col gap-6 bg-muted/5 group hover:bg-muted/10 transition-colors">
                            <div className="flex items-center gap-2">
                              ...
                              <div className="ml-auto w-6 h-6 rounded-full border border-border flex items-center justify-center bg-background shadow-sm">
