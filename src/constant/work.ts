    ...
    projects: [
      {
        ...
        images: [
          "birdBox/home-page.png",
          "birdBox/menu-page.png",
          "birdBox/cart-page.png",
        ],
        folder: "landing-page",
        icon: LayoutTemplate,
      ...
      },
      {
        ...
        images: [
          "smartCity/home-page.png",
          "smartCity/laporan-masyarakat.png",
          "smartCity/transparansi-page.png",
        ],
        folder: "landing-page",
        icon: LayoutTemplate,
    ...
    projects: [
      {
        ...
        images: [
          "spectra/Card Image.png",
          "spectra/Card Image-1.png",
          "spectra/Card Image-2.png",
        ],
      ...
      },
      {
        ...
        images: [
          "amana-dashboard/amana-dashboard.png",
          "amana-dashboard/Login.png",
          "amana-dashboard/Paket Umroh (3).png",
        ],
        mainImage: "amana-dashboard/amana-dashboard.png",
        folder: "dashboard-application",
        icon: MonitorSmartphone,
      ...
      },
      {
        ...
        images: [
          "enigma/Card Image.png",
          "enigma/Card Image-1.png",
          "enigma/Card Image-2.png",
        ],
        folder: "dashboard-application",
        icon: MonitorSmartphone,
      ...
      },
      {
        ...
        images: [
          "iapi/Card Image.png",
          "iapi/Card Image-1.png",
          "iapi/Card Image-2.png",
        ],
        folder: "dashboard-application",
        icon: MonitorSmartphone,
      ...
      },
      {
        ...
        images: [
          "accs/add-booking.png",
          "accs/booking-management.png",
          "accs/login-page.png",
        ],
        mainImage: "accs/booking-management.png",
        folder: "dashboard-application",
        icon: MonitorSmartphone,
      ...
      },
      {
        ...
        images: [
          "oiw/displaying-data.png",
          "oiw/login-page.png",
          "oiw/profile-details.png",
        ],
        mainImage: "oiw/displaying-data.png",
        folder: "dashboard-application",
        icon: MonitorSmartphone,
    ...
    projects: [
      {
        ...
        images: [
          "amana-mobile-app/Card Image.png",
          "amana-mobile-app/Card Image-1.png",
          "amana-mobile-app/Card Image-2.png",
        ],
        folder: "mobile-apps",
        icon: Smartphone,
      ...
      },
      {
        ...
        images: [
          "parx/Card Image.png",
          "parx/Card Image-1.png",
          "parx/Card Image-2.png",
        ],
        mainImage: "parx/Card Image.png", // We will try to map to a longer screen if available, else Card Image
        folder: "mobile-apps",
        icon: Smartphone,
